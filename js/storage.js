...
const FB_CONFIG = {
  ...
  authDomain:        "bandagamer-657f7.firebaseapp.com",
  databaseURL:       "https://bandagamer-657f7-default-rtdb.firebaseio.com",
  projectId:         "bandagamer-657f7",
  storageBucket:     "bandagamer-657f7.firebasestorage.app",
...
const Storage = (() => {
  ...
  async function migrarLocalAFirestore() {
    ...
    try {
      ...
      const rawLocal = localStorage.getItem("bandagamer_usuario"); // clave V1
      if (!rawLocal) return;
